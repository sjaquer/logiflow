...
>(
  (
    ...
    const [initialState] = React.useState(() => defaultOpen ?? getSidebarStateFromCookie());
  ...
  (
    ...
    if (collapsible === 'none') {
      return (
        <div
          className={cn(
            'flex h-full w-[--sidebar-width] shrink-0 flex-col',
            className
          )}
          ref={ref}
          {...props}
